           ...
           <div class="ps-3">
               <nav aria-label="breadcrumb">
                   <ol class="breadcrumb mb-0 p-0">
                       ...
                       <li class="breadcrumb-item active" aria-current="page">New course create</li>
                   </ol>
               </nav>
           </div>
           <div class="ms-auto">
               ...
               <div class="btn-group">
                   ...
                   <a href="{{ route('index.course') }}" class="btn btn-primary" ><i class="fadeIn animated bx bx-plus"></i> Course List </a>
               </div>
               </div>
           </div>
       </div>
